...
import { BookOpen, Sparkles, Save, Palette } from 'lucide-react';
...
export const ScriptEditor: React.FC<ScriptEditorProps> = ({ 
  ...
  return (
    <div className="flex-1 p-8 flex flex-col h-full max-w-5xl mx-auto w-full animate-in fade-in duration-500">
